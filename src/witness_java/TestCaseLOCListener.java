...
public class TestCaseLOCListener extends JavaParserBaseListener {
    ...
    public TestCaseLOCListener(Parser parser, BufferedTokenStream tokens, String workdir, String srcTests, String testClass, List<String> testList, Map<String, Integer> testMap, MultiMap<String, String> paramMap){
        this.parser = parser;
        this.tokens = tokens;
        ...
        if (ctx.EXTENDS() != null) {
            ...
            for (String importDecl : importList) {
                ...
                if (arr[arr.length - 1].equals(extendCls)) {
                    ...
                    TestCaseLOCListener testCaseLOCListener = new TestCaseLOCListener(parser, tokens, workdir, srcTests, testClass, testList, testMap, paramMap);
